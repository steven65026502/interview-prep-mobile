(() => {
  ...
  const companies = [
    ['台灣矽科宏晟科技','先談','三重儀電有新人入口，33–70K 不是個人核薪；今年有超時處分，須確認開發／監造比例、工時與出差。'],
    ['士林電機','先談','只問台北 ERP／PLM 資訊職轉介；同職舊匿名面試列 37.5K，沒有薪資勝出證據，本場名額未知。'],
    ['帆宣系統科技','補問','降為條件式：台南 PLC／HMI 面議，同地軟體匿名心得提及加班與海外支援；今年有出勤紀錄處分。'],
    ['漢唐集成','條件式','活動偏資深工程，監控也可能是監工；有具體新人開發 JD、Mentor 與待遇再談。'],
    ['高信工程','不優先','已讀系統／助理 JD 偏機電施工管理，不是軟體系統職；45K 起，年終兩個月附考核等條件。'],
    ['光洋應用材料科技','不優先','儀控較早刊載要求三年、偏廠務維護，另有重複超時處分；有另一份新人開發職再考慮。'],
